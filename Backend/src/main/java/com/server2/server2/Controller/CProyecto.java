...
@CrossOrigin(origins = "https://portafolio-web-d100a.web.app/")
public class CProyecto {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyecto dtoproy){      
        ...
        Proyecto proyecto = new Proyecto(dtoproy.getTitulo(), dtoproy.getResumen(), dtoproy.getEnlace(), dtoproy.getImagen());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyecto dtoproy){
        ...
        proyecto.setImagen(dtoproy.getImagen());
